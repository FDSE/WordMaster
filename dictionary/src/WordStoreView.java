...
public class WordStoreView extends JPanel
{
	///////////////////////////////////////////////////////////////////////////////
...
public void setCountModel()
	{
		...
		{
			name[0] = ReadDat.wordtype.get(i)+".词组";
...
//TODO
	class  tableListener implements FocusListener
	{
		...
		public void focusGained(FocusEvent e)
		{
		    ...
		    ReadDat.letter=ReadDat.wordtype.get(mousePressCount);
	...
	class    MousePressListener extends MouseAdapter
	{
		...
		{ 
		    ...
		    ReadDat.letter=ReadDat.wordtype.get(wordChooseCount);
